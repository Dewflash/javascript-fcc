...
// Function to update the preview and output
function updatePreview() {
  const htmlResult = convertMarkdown();
  
  // Display the raw HTML code in the output element
  document.getElementById('html-output').textContent = htmlResult;
  
  // Render the HTML cleanly in the preview element
